...
<body>
    <div class="container">
        <div class="header">
            <h1>SanDi•Med</h1>
            <p>Reporte de Historia Clínica</p>
        </div>
        <div class="content">
            <h2>Hola, {{ $nombre }}</h2>
            <p>A solicitud tuya, adjunto encontrarás el documento PDF con el reporte detallado de tu atención médica.</p>
            ...
            <p>Este documento contiene información confidencial de tu historia clínica (Resultados, Fórmulas, Incapacidades, etc). Por favor consérvalo de manera segura.</p>
            
            <div style="text-align: center;">
                <a href="{{ url('/') }}" class="btn">Ingresar al Portal</a>
            </div>
