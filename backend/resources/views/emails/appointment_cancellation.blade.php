...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>Hola, {{ $nombre }}</h2>
            <p>Le informamos que su cita médica programada ha sido <strong>cancelada</strong>.</p>
            ...
            <p>Si usted no realizó esta cancelación o desea programar una nueva cita, le invitamos a ingresar nuevamente a nuestro portal.</p>
            
            <div style="text-align: center;">
                <a href="https://devel82els.simde.com.co/AgendaVirtual/frontend/build/#/login" class="btn" style="color: #ffffff !important; text-decoration: none;">Reprogramar Cita</a>
            </div>
